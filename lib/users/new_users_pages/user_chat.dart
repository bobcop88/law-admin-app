...
class _UserChatState extends State<UserChat> {
                    ...
                    itemBuilder:(context, index) {
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: [
                            Row(
                              mainAxisAlignment: message.sender == widget.clientId ? MainAxisAlignment.start : MainAxisAlignment.end,
                              children: [
                                DecoratedBox(
                                  decoration: BoxDecoration(
                                    color: message.sender == widget.clientId ? Colors.grey : Colors.green,
  ...
  void sendMessage() async{
    ...
    await DatabaseChat().startChat(widget.clientId, 'QeyX9YxNuUOqBMABs3QsoiTNdqR2',  _messageController.text.trim());
